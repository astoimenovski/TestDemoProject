...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Password'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'This is sample coment')
